...
<section class="blog-featured-image">
    <div class="image-container">
        <div class="featured-image-placeholder" style="background: linear-gradient(135deg, #667eea, #764ba2); width: 100%; height: 400px; display: flex; align-items: center; justify-content: center; color: white; font-size: 4rem;">
            <?php 
            if (has_post_thumbnail()) {
                echo wp_get_attachment_image(get_post_thumbnail_id(), 'large', false, array('style' => 'width:100%;height:100%;object-fit:cover;'));
            } else {
                echo '💻';
            }
            ?>
    ...
    <div class="container">
        <div class="comments-wrapper glass-premium">
                    ...
                    wp_list_comments(array(
                        ...
                        'callback' => function($comment, $args, $depth) {
                            ...
                            <div class="comment glass">
                                <div class="comment-avatar" style="background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 50%; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.2rem;">👨</div>
                                <div class="comment-content">
                                    <div class="comment-header">
                                        <h4 class="comment-author"><?php comment_author(); ?></h4>
                                        <span class="comment-date"><?php printf(__('%s ago'), human_time_diff(get_comment_time('U'), current_time('timestamp'))); ?></span>
                                    </div>
                                    <p class="comment-text"><?php comment_text(); ?></p>
                                    <a href="#" class="comment-reply"><?php comment_reply_link(); ?></a>
                                </div>
                            </div>
                            <?php
                        }
            ...
            <div class="comment-form-wrapper">
                ...
                <?php 
                comment_form(array(
                    'comment_field' => '<div class="form-group"><textarea placeholder="Your Comment *" rows="6" name="comment" required></textarea></div>',
                    'submit_button' => '<button type="submit" class="btn btn-primary">Post Comment</button>',
                    'fields' => array(
                        'author' => '<div class="form-group"><input type="text" placeholder="Your Name *" name="author" required></div>',
                        'email' => '<div class="form-group"><input type="email" placeholder="Your Email *" name="email" required></div>',
                    )
                ));
                ?>
            </div>
